...
oPools_1_of_10_percent_first_replicate <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_10_percent_first_replicate.fasta") %>% 
  filter(candidates %in% insert_sequences_of_10_percent_first_replicate$candidates) %>% 
  dplyr::rename(oPools_1_sequence = sequence)
...
df_10_percent_first_replicate <- left_join(insert_sequences_of_10_percent_first_replicate, oPools_1_of_10_percent_first_replicate) %>%
  left_join(oPools_2_of_10_percent_first_replicate) %>% 
...
oPools_1_of_10_percent_second_and_third_replicates <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_10_percent_second_and_third_replicates.fasta") %>% 
...
df_10_percent_second_and_third_replicates <- left_join(insert_sequences_of_10_percent_second_and_third_replicates, oPools_1_of_10_percent_second_and_third_replicates) %>%
  left_join(oPools_2_of_10_percent_second_and_third_replicates) %>% 
...
oPools_1_of_25_percent_first_replicate <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_25_percent_first_replicate.fasta") %>% 
...
df_25_percent_first_replicate <- left_join(insert_sequences_of_25_percent_first_replicate, oPools_1_of_25_percent_first_replicate) %>% 
  left_join(oPools_2_of_25_percent_first_replicate) %>% 
...
oPools_1_of_25_percent_second_and_third_replicates <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_25_percent_second_and_third_replicates.fasta") %>% 
...
df_25_percent_second_and_third_replicates <- left_join(insert_sequences_of_25_percent_second_and_third_replicates, oPools_1_of_25_percent_second_and_third_replicates) %>% 
  left_join(oPools_2_of_25_percent_second_and_third_replicates) %>% 
...
oPools_1_of_50_percent_first_replicate <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_50_percent_first_replicate.fasta") %>% 
...
df_50_percent_first_replicate <- left_join(insert_sequences_of_50_percent_first_replicate, oPools_1_of_50_percent_first_replicate) %>% 
  left_join(oPools_2_of_50_percent_first_replicate) %>% 
...
oPools_1_of_50_percent_second_and_third_replicates <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_50_percent_second_and_third_replicates.fasta") %>% 
...
df_50_percent_second_and_third_replicates <- left_join(insert_sequences_of_50_percent_second_and_third_replicates, oPools_1_of_50_percent_second_and_third_replicates) %>% 
  left_join(oPools_2_of_50_percent_second_and_third_replicates) %>% 
...
oPools_1_of_100_percent_three_replicates <- turn_FASTA_into_dataframe("../1_generate candidate sequences/output/oPools_1_of_100_percent_three_replicates.fasta") %>% 
...
df_100_percent_three_replicates <- left_join(insert_sequences_of_100_percent_three_replicates, oPools_1_of_100_percent_three_replicates) %>% 
  left_join(oPools_2_of_100_percent_three_replicates) %>% 
